<template>
  <div class="seller" ref="seller">
    <div class="seller-cpntent">
      ...
      <split></split>
      <div class="pics">
        <h1 class="titles">商家实景</h1>
        <div class="pic-wapper" ref="picWrapper">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    watch: {
      // 因为seller是异步更新的数据，所以需要用watch来监听
      seller() {
        this._initScroll();
        this._initPics();
      }
